...
function __promptline {
  ...
  local a_bg="${wrap}48;5;64${end_wrap}"
  local a_sep_fg="${wrap}38;5;64${end_wrap}"
  ...
  local x_fg="${wrap}38;5;240${end_wrap}"
  ...
  local z_bg="${wrap}48;5;64${end_wrap}"
  local z_sep_fg="${wrap}38;5;64${end_wrap}"
  if [[ -n ${ZSH_VERSION-} ]]; then
